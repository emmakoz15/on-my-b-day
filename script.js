...
function nextChangeA(){
    ...
    let  img= document.getElementById("bnsimg").src = 'images/ce.jpg' //fix image   
}
...
function nextChangeB(){
    ...
    let  img= document.getElementById("bntimg").src = '#bad/broken/fix' //fix image   
}
...
function nextChangeC(){
    ...
    let  img= document.getElementById("bnfimg").src = '#bad/broken/fix' //fix image   
}
...
function nextChangeD(){
    ...
    let  img= document.getElementById("bnfiimg").src = '#bad/broken/fix' //fix image   
}
